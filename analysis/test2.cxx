...
void test2(int RunNumber = 3566) {
  ...
  std::string dbfile = hallc_replay_dir;

  std::string file_name           = hallc_replay_dir + "/DBASE/SHMS/standard.database";
  std::string kinematics_filename = hallc_replay_dir + "/DBASE/SHMS/standard.kinematics";
  ...
  std::cout << std::abs(
      hcana::json::FindVarValueOr(hc_parms, "htheta_lab", 0.0));
  std::cout << hcana::json::FindVarValueOr(hc_parms, "hpcentral", 0.0);
  std::cout << hcana::json::FindVarValueOr(hc_parms, "ptheta_lab", 0.0);
  std::cout << hcana::json::FindVarValueOr(hc_parms, "ppcentral", 0.0);
