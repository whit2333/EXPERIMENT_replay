void replay_production_coin_sidis (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/COIN/PRODUCTION/coin_production_sidis.def");
  // Define cuts file
  analyzer->SetCutFile("DEF-files/COIN/PRODUCTION/CUTS/coin_production_sidis_cuts.def");  // optional
